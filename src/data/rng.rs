...
impl Chance {
	pub fn new() -> Self { Self(Random::new()) }

	pub fn threshold(&self) -> f32 { self.0.get(0f32..1f32) }

	pub fn eval(&self, chance: f32) -> bool { self.threshold() <= chance }
}
