use crate::{
	data::{
		items::InventoryItem,
		rng::Chance,
		user::{DBUser, DBUserError},
	},
	systems::autoconfig::data::{ServerConfigChannelId, ServerConfigRoleId},
...
impl DBState {
	...
	pub fn update_user(&mut self, id: &UserId, user: DBUser) { self.users.insert(*id, user); }
